...
```{r message=FALSE, paged.print=TRUE, warnings = FALSE}
...
Not all movies in the Criterion Collection have a spine number, but the find_by_spine function can be helpful for the >1500 movies that do.
